...
<jsp:include page="header.jsp" flush="true"></jsp:include>
   <div class="qn-header">
	...
	<div class="shouxia">
		<div class="shoux">
		    <div class="shouph">
		         <div class="sphoto1"><img src="img/s1.png"/></div>
		         <div class="sphoto2" ><img src="img/s2.jpg" /></div>
		         <div class="sphoto3" ><img src="img/s3.jpg"  /></div>
		         <div class="sphoto4" ><img src="img/s4.jpg"/></div>
		    </div>
			<div class="mainbox-right">
				<div class="nav-btns clrfix">
					<a target="_blank" class="btn new-plan" href="createxingcheng.jsp"></a><a
						target="_blank" class="btn new-note" href="createyouji.jsp"></a>
				</div>
