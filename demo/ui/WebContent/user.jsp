...
<jsp:include page="header.jsp" flush="true"></jsp:include>
	...
	<div class="qn-skin">
		<div class="qn-page">
			<div class="mainbox clrfix">
				<div class="fl mainbox-left">
					<div class="b-home-detail">
						<!-- <div class="e-detail-banner">
							<a target="_blank" href="//travel.qunar.com/youji/create"
								class="btn notes"></a><a target="_blank"
								href="//travel.qunar.com/place/" class="btn write-comment"></a><a
								target="_blank"
								href="//travel.qunar.com/travelbook/list.htm?order=hot_heat"
								class="btn send-comment"></a><a target="_blank"
								href="//travel.qunar.com/travelbook/phone/"
								class="btn client-share"></a>
						</div> -->
						<div class="add">
							<a href="//travel.qunar.com/travelbook/topic/2890"
								class="add-img" target="_blank"></a>
						</div>
						<div class="b-fans b-home-fans">
							<h2 class="tit-traveller">TA们都是聪明旅行家</h2>
							<ul class="fans-list clrfix">
								<li class="item"><dl class="fans-info clrfix">
										<dt class="pic fl">
											<a href="//travel.qunar.com/space/1837996@qunar"
												target="_blank"><img
												src="https://qcommons.qunar.com/headshot/headshotsById/1837996.png?s&amp;ssl=true" /></a>
										</dt>
										<dd class="intro fr">
											<h3 class="name">
												<a href="//travel.qunar.com/space/1837996@qunar"
													target="_blank">任紫玉</a><a class="user_name_icon"
													href="//travel.qunar.com/travelbook/topic/2890"
													target="_blank" data-beacon="traveler"></a>
											</h3>
											<div class="info">
								...
								<li class="item"><dl class="fans-info clrfix">
										<dt class="pic fl">
											<a href="//travel.qunar.com/space/123316122@qunar"
												target="_blank"><img
												src="https://qcommons.qunar.com/headshot/headshotsById/123316122.png?s&amp;ssl=true" /></a>
										</dt>
										<dd class="intro fr">
											<h3 class="name">
												<a href="//travel.qunar.com/space/123316122@qunar"
													target="_blank">小达叔叔</a><a class="user_name_icon"
													href="//travel.qunar.com/travelbook/topic/2890"
													target="_blank" data-beacon="traveler"></a>
											</h3>
											<div class="info">
								...
								<li class="item"><dl class="fans-info clrfix">
										<dt class="pic fl">
											<a href="//travel.qunar.com/space/298229@qunar"
												target="_blank"><img
												src="https://qcommons.qunar.com/headshot/headshotsById/298229.png?s&amp;ssl=true" /></a>
										</dt>
										<dd class="intro fr">
											<h3 class="name">
												<a href="//travel.qunar.com/space/298229@qunar"
													target="_blank">不旅不婷</a><a class="user_name_icon"
													href="//travel.qunar.com/travelbook/topic/2890"
													target="_blank" data-beacon="traveler"></a>
											</h3>
											<div class="info">
								...
								<li class="item"><dl class="fans-info clrfix">
										<dt class="pic fl">
											<a href="//travel.qunar.com/space/152966678@qunar"
												target="_blank"><img
												src="https://qcommons.qunar.com/headshot/headshotsById/152966678.png?s&amp;ssl=true" /></a>
										</dt>
										<dd class="intro fr">
											<h3 class="name">
												<a href="//travel.qunar.com/space/152966678@qunar"
													target="_blank">dszf4127</a><a class="user_name_icon"
													href="//travel.qunar.com/travelbook/topic/2890"
													target="_blank" data-beacon="traveler"></a>
											</h3>
											<div class="info">
								...
								<li class="item"><dl class="fans-info clrfix">
										<dt class="pic fl">
											<a href="//travel.qunar.com/space/123265252@qunar"
												target="_blank"><img
												src="https://qcommons.qunar.com/headshot/headshotsById/123265252.png?s&amp;ssl=true" /></a>
										</dt>
										<dd class="intro fr">
											<h3 class="name">
												<a href="//travel.qunar.com/space/123265252@qunar"
													target="_blank">手边巴黎urruolan</a><a class="user_name_icon"
													href="//travel.qunar.com/travelbook/topic/2890"
													target="_blank" data-beacon="traveler"></a>
											</h3>
											<div class="info">
								...
								<li class="item"><dl class="fans-info clrfix">
										<dt class="pic fl">
											<a href="//travel.qunar.com/space/139394454@qunar"
												target="_blank"><img
												src="https://qcommons.qunar.com/headshot/headshotsById/139394454.png?s&amp;ssl=true" /></a>
										</dt>
										<dd class="intro fr">
											<h3 class="name">
												<a href="//travel.qunar.com/space/139394454@qunar"
													target="_blank">孟夕</a><a class="user_name_icon"
													href="//travel.qunar.com/travelbook/topic/2890"
													target="_blank" data-beacon="traveler"></a>
											</h3>
											<div class="info">
							...
							<a href="#" class="btn-huan"><span class="icon"></span> 更换一批</a>
						</div>
					</div>
				</div>
				<div class="fr mainbox-right">
					<div class="nav-btns clrfix">
						<a target="_blank" class="btn new-plan"
							href="createxingcheng.jsp"></a><a target="_blank"
							class="btn new-note" href="createyouji.jsp"></a>
					</div>
