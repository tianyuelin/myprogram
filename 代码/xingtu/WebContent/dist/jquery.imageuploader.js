    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            ...
            var dom = {
                ...
                selectButton: $('<input name="files" style="height: 0; width: 0;" id="fileinput' + index + '" type="file" multiple class="js-uploader__file-input uploader__file-input">' +
                ...
                secondarySelectButton: $('<input name="files" style="height: 0; width: 0;" id="secondaryfileinput' + index + '" type="file"' +
